...
const formSchema = z.object({
  ...
  departureDate: z.date().refine((date) => !!date, { message: "Departure date date is required" }),
...
const HeroForm = () => {
  ...
  const onSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    const query = new URLSearchParams({
        ...
        departureDate: format(arrivalDate,'yyyy-MM-dd'),
        ...
        <div className="bg-gray-800 bg-opacity-75 p-6 w-full max-w-5xl shadow-lg rounded-md">
          <Form {...form}>
            ...
            >
              ...
              />
              <Button variant="mybutton" type="submit" className=" col-span-1 md:col-span-4">
                Search
              </Button>
            </form>
          </Form>
